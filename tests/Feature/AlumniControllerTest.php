...
class AlumniControllerTest extends TestCase
{
    ...
    public function test_existing_student_already_registered_as_alumni_returns_validation_error(): void
    {
        ...
        $bookBefore = BookJasah::count();
        $response = $this->postJson(route('alumni.store'), ['nama_lengkap' => 'Alumni Uji', 'nisn' => '1234567890123456', 'id_jurusan' => $jurusan->id_jurusan, 'tahun_lulus' => now()->year, 'no_whatsapp' => '08123456789', 'email' => 'alumni@example.test', 'status' => 'Bekerja', 'bersedia_mentor' => false]);
