  ...
  <section class="mentoring">
    ...
    <div class="mentor-grid">
      <div class="mentor-card">
        ...
        <p class="mentor-desc">Berawal dari PKL di bengkel, sekarang menjadi mekanik senior dan membimbing siswa dalam perawatan kendaraan.</p>
        <button
        type="button"
        class="mentor-btn"
        onclick="openMentoringModal('Andi Pratama')">
        Ajukan Mentoring
      </button>
      </div>
      <div class="mentor-card">
        ...
        <hr class="divider">
        <div class="verified">✓ Data Terverifikasi TU</div>
        <p class="mentor-desc">Berpengalaman menangani berbagai jenis kendaraan dan sistem kelistrikan otomotif.</p>
        <button
        type="button"
        class="mentor-btn"
        onclick="openMentoringModal('Budi Santoso')">
        Ajukan Mentoring
      </button>
      </div>
      <div class="mentor-card">
        ...
        <hr class="divider">
        <div class="verified">✓ Data Terverifikasi TU</div>
        <p class="mentor-desc">Memulai karier sebagai siswa PKL dan berkembang menjadi service advisor di bengkel resmi.</p>
        <button
        type="button"
        class="mentor-btn"
        onclick="openMentoringModal('Rizky Maulana')">
        Ajukan Mentoring
      </button>
      </div>
    </div>
